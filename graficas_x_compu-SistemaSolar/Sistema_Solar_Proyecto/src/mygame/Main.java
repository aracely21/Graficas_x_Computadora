...
public class Main extends SimpleApplication {
    ...
    public void simpleInitApp() {
         ...
         * material de este.
         */
        //Se crean los objetos para poder vizualizarlos
         ...
         **/
            ...
            Sphere marte = new Sphere(30, 30, 0.7f);
         ...
         **/
        //Se le proporciona diferente color a los objetos
        ...
        nodeMercurio.setLocalTranslation(0f,0, 6f);
        nodeMarte.setLocalTranslation(0f,4f, 0f);
    ...
    public void simpleUpdate(float tpf) {
        ...
        **/
        ...
        //gira en el eje "y"
        rootNode.getChild("nodo_pivotemercurio").rotate(tpf*0.5f,0,0);
        
       //tpf*1 indica que se movera una vez mas de la velocidad que el nodo de la tierra 
       //Gira en el eje "z"
        rootNode.getChild("nodo_pivotemarte").rotate(0,0, tpf*1);
    }
